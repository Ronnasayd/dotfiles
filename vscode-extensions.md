...
ext install rocketseat.rocketseatreactnative # rocketseat react native
ext install rocketseat.rocketseatreactjs # rocketseat reactjs
ext install stylelint.vscode-stylelint # stylelint
ext install jpoissonnier.vscode-styled-components # styled components
ext install wakatime.vscode-wakatime # wakatime
ext install dbaeumer.vscode-eslint # eslint
ext install ecmel.vscode-html-css # HTML CSS Support
ext install xabikos.javascriptsnippets # javascript es6 snippets
