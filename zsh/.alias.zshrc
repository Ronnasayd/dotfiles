...
alias ogrb="open-remote-git-repository-with-branch" # (Fn) Open remote repository URL in current branch at browser (~/.functions.zshrc)
alias ogrpr="open-remote-git-repository-pull-request" # (Fn) Open remote repository URL for creating a pull request in browser (~/.functions.zshrc)
alias orj="open-remote-Jira" # (Fn) Open remote Jira task by branch (~/.functions.zshrc)
alias dcb="docker-compose-build" # (Fn) Build Docker containers using a specified Docker Compose file: dcb <docker_compose_file> (~/.functions.zshrc)
alias dcu="docker-compose-up" # (Fn) Start Docker containers using a specified Docker Compose file: dcu <docker_compose_file> (~/.functions.zshrc)
alias dcd="docker-compose-down" # (Fn) Down Docker containers using a specified Docker Compose file: dcd <docker_compose_file> (~/.functions.zshrc)
...
alias sljd="jump-to-original-dir" # (Fn) Jump to original directory of a symbolic link (~/.functions.zshrc)
...
alias aad="aria-download" # (Fn) Download a file using aria2c with optimized settings: adown <file_url> <output_filename> (~/.functions.zshrc)
alias lv="loop-video" # (Fn) Loop a video file indefinitely using ffmpeg: loopvideo <input_video> <output_video> (~/.functions.zshrc)
...
alias gwl="git worktree list" # List all worktrees associated with the repository
alias gwa="git worktree add" # Add a new worktree linked to the repository
alias gwd="git worktree remove" # Remove a worktree from the repository
alias gws="git worktree prune" # Prune worktrees that have been removed from
...
alias fdd='fdfind -t d' # Find directories using fd command
alias fdf='fdfind -t f' # Find files using fd command
alias fd='fdfind' # Find files/directories using fd command
...
alias blgs="bat --paging=never -l log" # Colorize log messages with bat
...
alias asdfl="asdf set" # Set the package local version
alias asdfg="asdf set --home" # Set the package global version
alias asdfre="asdf reshim" # Recreate shims for version of a package
alias asdfcur="asdf current" # List current versions
alias asdfpys="asdf set --home python system" # Set the Python system version in asdf to avoid conflicts
...
alias rss="open-rss" # Open current rss link showing at conky
